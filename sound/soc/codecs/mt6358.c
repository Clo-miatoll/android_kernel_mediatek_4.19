...
/* add for HTH-290270 to repair the master and vice mic test by lxd start*/
unsigned char m_HeadsetPlugState = 0;
/* add for HTH-290270 to repair the master and vice mic test by lxd end*/
...
/*for HTH-287230 modify by lxd in 2023/3/13 begin*/
        if((m_HeadsetPlugState == 0) && (priv->mux_select[MUX_PGA_R] == 2)) {
          if (mux == 1)
            priv->mux_select[MUX_PGA_R] = 3;
          if (mux == 3)
            priv->mux_select[MUX_PGA_R] = 1;
        }
/*for HTH-287230 modify by lxd in 2023/3/13 end*/
...
/*for HTH-287230 modify by lxd in 2023/3/13 begin*/
        if((m_HeadsetPlugState == 0) && (priv->mux_select[MUX_PGA_L] == 2)) {
          if (mux == 1)
